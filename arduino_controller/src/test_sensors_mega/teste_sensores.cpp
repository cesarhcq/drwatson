...
#define MOTOR_LEFT 1          // Motor Left PID Controll
#define MOTOR_RIGHT 2         // Motor Right PID Controll
...
void setup()
{
  //SabertoothTXPinSerial.begin(9600); // MEGA-> SABERTOOTH: 19 (RX), 18 (TX)
  Serial.begin(57600);              // MEGA-> RASPBERRY: Serial PINS = 0 (RX), 1 (TX)
  ...
  attachInterrupt(1, call_encoder_Right, RISING); // Int.1 encoder right pin 3 (Interrupction - Arduino Mega)

  attachInterrupt(0, call_encoder_Left, RISING); // Int.0 encoder left pin 2 (Interrupction - Arduino Mega)
