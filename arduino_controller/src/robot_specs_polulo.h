...
#define ENCODER_PULSE_LEFT 2.5 //2.5 0.2 0.15
#define ENCODER_PULSE_RIGH 2.5 //0.5 0.2 0.15 0.25
#define ENCODER_FILTER 10 // se aumentar, sinal mais constante, resposta lenta
